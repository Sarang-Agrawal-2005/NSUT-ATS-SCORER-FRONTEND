            ...
            <html>
                <head>
                    <style>
                        ...
                        .instructions { background: #FEF3F2; border: 1px solid #FECACA; padding: 15px; border-radius: 8px; margin: 20px 0; }
                        .latex-code { background: #F9FAFB; border: 1px solid #D1D5DB; border-radius: 8px; padding: 15px; margin: 20px 0; }
                        textarea { width: 100%; height: 400px; font-family: 'Courier New', monospace; font-size: 12px; border: 1px solid #D1D5DB; border-radius: 4px; padding: 10px; box-sizing: border-box; }
                        .btn { background: #DC2626; color: white; padding: 10px 20px; border: none; border-radius: 6px; cursor: pointer; text-decoration: none; display: inline-block; margin: 5px; }
                ...
                <body>
                    <div class="header">
                        <h2 style="margin: 0;">✅ Resume Generated Successfully!</h2>
                        <p style="margin: 10px 0 0 0;">LaTeX compilation is not available on this server, but your resume code is ready!</p>
                    </div>
                    
                    <div class="success-note">
                        <strong>Good news!</strong> Your resume has been generated in LaTeX format. This is actually the professional standard for academic and technical resumes!
                    </div>
                    
                    <div class="instructions">
                        <p><strong>Quick Start Guide:</strong></p>
                        <ol>
                            <li><strong>Copy</strong> the LaTeX code below (click "Copy Code" button)</li>
                            <li><strong>Go to</strong> <a href="https://www.overleaf.com" target="_blank">Overleaf.com</a> (free, no installation needed)</li>
                            <li><strong>Create</strong> a new blank project</li>
                            <li><strong>Replace</strong> all content with the copied code</li>
                            <li><strong>Upload</strong> NSUT logo (optional - will work without it too)</li>
                            <li><strong>Click</strong> "Recompile" to generate your professional PDF</li>
                        </ol>
                        <p><em>💡 Tip: Overleaf will save your resume online and you can edit it anytime!</em></p>
                    </div>

                    <div class="latex-code">
                        <h3>Your NSUT Resume LaTeX Code:</h3>
                        ...
                        <a href="https://www.overleaf.com" target="_blank" class="btn">🚀 Open Overleaf</a>
                        <button class="btn" onclick="downloadLatex()" style="background: #059669;">💾 Download .tex File</button>
                    </div>
                    ...
                    <script>
                        function copyToClipboard() {
                            ...
                            alert('✅ LaTeX code copied to clipboard! Now go to Overleaf and paste it.');
                        }
